 ...
 *  Homework 5
 *
 *  Implement basic lighting for a 3d scene
	...
	double th, double ph)
{
	...
	// Body
	cylinder(0, 2.2, 0, 1, 1, 7, 90, 150, 150, 150);
...
void warehouse(double x, double y, double z)
{
	...
	// Floor
	cube2(0, -.6, 0, 10, .6, 10, 0, 100, 100, 100);

	// Back Wall
	cube2(0, 10, -9.5, 10, 10, .5, 0, 100, 100, 150);

	// Left Wall
	cube2(-9.5, 10, -7, .5, 10, 3, 0, 100, 125, 10);
	cube2(-9.5, 10, 7, .5, 10, 3, 0, 100, 125, 10);
	cube2(-9.5, 3, 0, .5, 3, 4, 0, 100, 125, 10);
	cube2(-9.5, 17, 0, .5, 3, 4, 0, 100, 125, 10);

	// Window
	cube2(-9.5, 10, 0, .5, 4, 4, 0, 100, 100, 200);
